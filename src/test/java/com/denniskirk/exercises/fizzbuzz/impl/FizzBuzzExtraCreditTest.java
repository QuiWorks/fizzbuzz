...
public class FizzBuzzExtraCreditTest extends FizzBuzzTest{
    ...
    private FizzBuzzExtraCredit getTestInstance(int fizz, int buzz) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        Class<Integer> type = Integer.TYPE;
        return FizzBuzzExtraCredit.class.getDeclaredConstructor(type, type).newInstance(fizz, buzz);
    }

    private void setState(int fizz, int buzz) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
